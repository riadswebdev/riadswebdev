...
<table>
  <tr>
    <td>
      <strong>Programming Hero</strong> · Frontend Web Development Learner<br/>
      <em>2025 – Present</em>
      <ul>
        <li>Built full-stack applications with React, Next.js, Node.js, Express, and MongoDB</li>
        <li>Implemented authentication systems, REST APIs, and database integration</li>
        <li>Designed responsive interfaces with Tailwind CSS and HeroUI</li>
        <li>Managed version control with Git/GitHub and deployed to Vercel & Render</li>
      </ul>
    </td>
  </tr>
</table>
...
| Tailwind CSS, HeroUI, DaisyUI, Framer Motion, GSAP, Lenis | Google Authentication | ChatGPT, Cursor AI, GitHub Copilot |

<img src="https://capsule-render.vercel.app/api?type=waving&color=3B82F6&height=80&section=footer" width="100%" alt=""/>

<h2 align="left">Languages</h2>

> Bangla (Native) · English (Intermediate) · Hindi (Speaking)
